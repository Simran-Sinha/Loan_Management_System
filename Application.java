...
public class Application extends JDialog implements ActionListener
{
	Connection con;
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		else
		{
			...
			boolean t=false;
			if(!PatternMatching23.nameCheck(txt5.getText()))
			{
			...
			if(!PatternMatching23.mobCheck(txt4.getText()))
			{
			...
			if(!PatternMatching23.numCheck(txt3.getText()))
			{
				lbl31.setVisible(true);
				txt3.setText("");
				t=true;
			}
			if(!PatternMatching23.nameCheck(txt6.getText()))
			{
			...
			if(!PatternMatching23.numCheck(txt7.getText()))
			{
