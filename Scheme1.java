...
import java.awt.event.*;
import java.sql.*;
public class Scheme1 extends JDialog implements ActionListener
{
	JPanel p= new JPanel();
	JLabel lb1=new JLabel(new ImageIcon(ImageResize.resize("img/car10.jpg",160,150)));;
	JPanel p1=new JPanel();
	JPanel pp=null;
	JLabel lb= new JLabel("  SBI Auto Loan Schemes");
	...
	JLabel lb2=new JLabel(new ImageIcon(ImageResize.resize("img/man.png",120,125)));;
	JLabel lb3=new JLabel(new ImageIcon(ImageResize.resize("img/man.png",120,125)));;
	JLabel lb4=new JLabel(new ImageIcon(ImageResize.resize("img/man.png",120,125)));;
	JLabel lb5=new JLabel(new ImageIcon(ImageResize.resize("img/man.png",120,125)));;
	
	JLabel title1=new JLabel("<html>Repayment tenure</html>");
	JLabel title2=new JLabel("<html><center>Reducing Balance</center></html>");
	JLabel title3=new JLabel("<html>Lowest Interest Rates</html>");
	JLabel title4=new JLabel("<html>No advance EMI</html>");
	JButton logout=new JButton("Previous");
	
	JLabel body1=new JLabel("<html><p>The State Bank of India has designed the car loan product keeping the convenience of the borrowers in mind.</p></html>");
	JLabel body2=new JLabel("<html><p>Another added advantage of SBI car loans is that the customers are charged interest at daily reducing balance.</p></html>");
	JLabel body3=new JLabel("<html><p>State Bank of India car loan interest rates are offered at both fixed as well as flexible rates</p></html>");
	JLabel body4=new JLabel("<html><p>The State Bank of India car loan borrowers enjoys flexible options to pay EMIs.</p></html>");
	...
	Scheme1()
	{
		...
		panel.add(lb4);
		panel.add(lb5);
		//lb2.setBorder(BorderFactory.createLineBorder(new Color(0,162,232),5));
		//lb3.setBorder(BorderFactory.createLineBorder(new Color(0,162,232),5));
		//lb4.setBorder(BorderFactory.createLineBorder(new Color(0,162,232),5));
		//lb5.setBorder(BorderFactory.createLineBorder(new Color(0,162,232),5));
		//spanel.add(lb6);
