...
import java.sql.*;
import java.io.*;
public class CustomerDetails extends JDialog implements ActionListener
{
	Connection con;
	...
	JLabel lb = new JLabel(" CUSTOMER DETAILS");
	...
	CustomerDetails()
	{
		...
		try{
			...
			{				
				...
				addComponent(sp,new JLabel("Address:"),230,160,100,40);addComponent(sp,new JLabel(rst.getString(21)),340,160,100,40);
