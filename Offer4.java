...
public class Offer4 extends JDialog implements ActionListener
{
	Connection con;
	...
	JLabel pic1 = new JLabel(new ImageIcon(ImageResize.resize("img/autoloan.png",600,400)));;
	Border thickBorder = new LineBorder(new Color(0,0,160), 5);
	JLabel lb = new JLabel("           LOAN OFFER");
	JLabel lb1 = new JLabel("1. Optional SBI Life Insurance cover available");
	JLabel lb2 = new JLabel("2. Interest calculated on Daily Reducing Balance");
	JLabel lb3 = new JLabel("<html>3. Lowest Interest Rates and EMI</html>");
	JLabel lb4 = new JLabel("<html>4. Longest Repayment Tenure(7 year)</html>");
	...
	Offer4()
	{
		...
		lb3.setBounds(510,460,500,60);
		lb4.setBounds(510,510,500,60);
