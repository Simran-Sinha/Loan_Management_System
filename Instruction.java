...
public class Instruction extends JFrame 
{
	...
	Instruction()
	{
		...
		panel.add(pan_title);pan_title.setBounds(30,10,1300,100);pan_title.setLayout(null);pan_title.add(pan_title_lbl);pan_title_lbl.setBounds(10,10,1300,90);
		pan_title.setBackground(Color.WHITE);pan_title_lbl.setBackground(new Color(0,162,232));pan_title_lbl.setForeground(Color.WHITE);pan_title_lbl.setOpaque(true);pan_title_lbl.setFont(new Font("Arial",Font.BOLD,45));
		...
		pan1.setBounds(60,150,200,400);pan1.setLayout(null);pan1.setBorder(BorderFactory.createLineBorder(Color.BLACK,2));
		pan2.setBounds(280,150,200,400);pan2.setLayout(null);pan2.setBorder(BorderFactory.createLineBorder(Color.BLACK,2));
		pan3.setBounds(490,150,200,400);pan3.setLayout(null);pan3.setBorder(BorderFactory.createLineBorder(Color.BLACK,2));
		pan4.setBounds(700,150,200,400);pan4.setLayout(null);pan4.setBorder(BorderFactory.createLineBorder(Color.BLACK,2));
		pan5.setBounds(910,150,200,400);pan5.setLayout(null);pan5.setBorder(BorderFactory.createLineBorder(Color.BLACK,2));
		pan6.setBounds(1120,150,200,400);pan6.setLayout(null);pan6.setBorder(BorderFactory.createLineBorder(Color.BLACK,2));
		pan1.add(num1);num1.setBounds(80,10,100,40);num1.setForeground(new Color(0,0,121));num1.setFont(new Font("Arial",Font.BOLD,40));
		pan2.add(num2);num2.setBounds(80,10,100,40);num2.setForeground(new Color(0,0,121));num2.setFont(new Font("Arial",Font.BOLD,40));
		pan3.add(num3);num3.setBounds(80,10,100,40);num3.setForeground(new Color(0,0,121));num3.setFont(new Font("Arial",Font.BOLD,40));
		pan4.add(num4);num4.setBounds(80,10,100,40);num4.setForeground(new Color(0,0,121));num4.setFont(new Font("Arial",Font.BOLD,40));
		pan5.add(num5);num5.setBounds(80,10,100,40);num5.setForeground(new Color(0,0,121));num5.setFont(new Font("Arial",Font.BOLD,40));
		pan6.add(num6);num6.setBounds(80,10,100,40);num6.setForeground(new Color(0,0,121));num6.setFont(new Font("Arial",Font.BOLD,40));
		pan1.add(dash1);dash1.setBounds(0,60,150,20);dash1.setForeground(new Color(0,0,121));dash1.setFont(new Font("Arial",Font.BOLD,20));
