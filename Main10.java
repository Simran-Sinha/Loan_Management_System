...
import java.sql.*;
public class Main10 extends JDialog implements ActionListener
{
	JPanel p= new JPanel();
	...
	JLabel lb2=new JLabel(new ImageIcon(ImageResize.resize("img/sbiedu.png",1250,450)));;
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		try
		{
		Desktop.getDesktop().open(new java.io.File("img/pdf10.pdf"));
		}
		catch(Exception e)
		{
		e.printStackTrace();
