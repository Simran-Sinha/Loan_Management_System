...
import java.sql.*;
public class User1 extends JDialog implements ActionListener
{
	Connection con;
	...
	JLabel lb = new JLabel("          Home Loan");
	DefaultMutableTreeNode main=new DefaultMutableTreeNode("SBI Home Loan Details");
	DefaultMutableTreeNode home1=new DefaultMutableTreeNode("Home Loan");
...
tree.addMouseListener(
		new MouseAdapter()
		{
			public void mouseClicked(MouseEvent evt)
			{
				...
				else if(title.equals("Home Loan"))
				{
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		try
		{
		Desktop.getDesktop().open(new java.io.File("img/home.pdf"));
		}
		catch(Exception e)
		{
		e.printStackTrace();
