...
import java.sql.*;
public class Help3 extends JPanel //implements FocusListener
{
	JPanel p=new JPanel();
	JLabel q1=new JLabel("How to know the benefits of SBI Student Loans?");
	JLabel q2=new JLabel("How to Apply for a loan?");
	JLabel q3=new JLabel("How to know about various schemes available in SBI Student Loan.?");
...
{  
    ...
    {  
       ...
       // i have assumed you have declared "frame" as instance variable
      				...
      				Instruction2 b1=new Instruction2();
