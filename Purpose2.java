...
public class Purpose2 extends JDialog implements ActionListener
{
	Connection con;
...
JOptionPane.showMessageDialog(null,"A");
		...
		else
		{
			...
			boolean t=false;
			if(!PatternMatching21.numCheck(txt1.getText()))
			{
			...
			if(!PatternMatching21.numCheck(txt3.getText()))
			{
