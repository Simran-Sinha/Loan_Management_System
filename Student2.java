...
import java.sql.*;
public class Student2 extends JDialog implements ActionListener
{
	Connection con;
	...
	JLabel lb = new JLabel("          Student Loan");
	DefaultMutableTreeNode main=new DefaultMutableTreeNode("SBI Student Loan Details");
	DefaultMutableTreeNode home1=new DefaultMutableTreeNode("Student Loan");
...
tree.addMouseListener(
		new MouseAdapter()
		{
			public void mouseClicked(MouseEvent evt)
			{
				...
				else if(title.equals("Student Loan"))
				{
				new Main10();
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		try
		{
		Desktop.getDesktop().open(new java.io.File("img/studentloan.pdf"));
		}
		catch(Exception e)
		{
		e.printStackTrace();
