...
public class Offer3 extends JDialog implements ActionListener
{
	Connection con;
	...
	JLabel pic1 = new JLabel(new ImageIcon(ImageResize.resize("img/studentloan.png",600,400)));;
	Border thickBorder = new LineBorder(new Color(0,0,160), 5);
	JLabel lb = new JLabel("           LOAN OFFER");
	JLabel lb1 = new JLabel("1. Develop future by acquiring vocational skills");
	JLabel lb2 = new JLabel("2. The Reset Period for Education Loan is 1y");
	JLabel lb3 = new JLabel("<html>3. does not charge any hidden fee</html>");
	JLabel lb4 = new JLabel("<html>4. The maximum tenure is 15 years</html>");
	...
	Offer3()
	{
		...
		lb3.setBounds(500,460,500,60);
		lb4.setBounds(500,510,500,60);
