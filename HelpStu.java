...
import java.sql.*;
public class HelpStu extends JDialog implements ActionListener
{
	Connection con;
	...
	JLabel lb1=new JLabel(new ImageIcon(ImageResize.resize("img/serach.png",270,270)));;
		...
		setLayout(null);
			...
			c1.addItem("Select the schemes available in Student loan");
			c1.addItem("student loan");
		...
		if(evt.getSource()==c1)
		{
			if(c1.getSelectedItem().equals("student loan")||c1.getSelectedItem().equals("Student loan Schemes"))
			{
