...
import java.awt.print.*;
public class Customer extends JDialog implements Printable,ActionListener
{
	...
	Customer(String strid)
	{
		...
		full_name_txt.setEnabled(false);
		...
		spouse_name_txt.setEnabled(false);
		addComponent(panel,father_name,50,350,200,40);addComponent(panel,father_name_txt,250,350,200,40);
		father_name_txt.setEnabled(false);
		mother_name_txt.setEnabled(false);
		...
		nationality_txt.setEnabled(false);
		...
		place_of_birth_txt.setEnabled(false);
		addComponent(panel,permanent_add,50,650,200,40);addComponent(panel,jsp1,250,650,200,60);
		permanent_add_txt.setEnabled(false);
		local_add_txt.setEnabled(false);
		...
		addComponent(panel,print,200,1260,150,50);addComponent(panel,cancel,400,1260,150,50);
