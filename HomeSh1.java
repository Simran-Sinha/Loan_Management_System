...
public class HomeSh1 extends JPanel //implements ActionListener
{
	JPanel p= new JPanel();
	...
	void showTable(String st[][],String st1[])
	{
		...
		tab.getColumnModel().getColumn(1).setPreferredWidth(310);
		tab.setRowHeight(40);
