...
import java.sql.*;
public class HelpCar extends JDialog implements ActionListener
{
	Connection con;
	...
	JLabel lb1=new JLabel(new ImageIcon(ImageResize.resize("img/serach.png",270,270)));;
		...
		setLayout(null);
			...
			c1.addItem("Select the schemes available in Car loan");
			c1.addItem("Auto loan");
		...
		if(evt.getSource()==c1)
		{
			if(c1.getSelectedItem().equals("Auto loan")||c1.getSelectedItem().equals("Select the schemes available in Car loan"))
			{
