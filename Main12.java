...
import java.sql.*;
public class Main12 extends JDialog implements ActionListener
{
	JPanel p= new JPanel();
	...
	JLabel lb2=new JLabel(new ImageIcon(ImageResize.resize("img/home11.jpg",1100,400)));;
	...
	Main12()
	{
		...
		lb2.setBounds(100,250,1100,400);
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		try
		{
		Desktop.getDesktop().open(new java.io.File("img/pdf12.pdf"));
		}
		catch(Exception e)
		{
		e.printStackTrace();
