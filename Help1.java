...
import java.sql.*;
public class Help1 extends JPanel //implements FocusListener
{
	JPanel p=new JPanel();
	JLabel q1=new JLabel("How to know about various schemes available in SBI.?");
	JLabel q2=new JLabel("How to Apply for a loan?");
	JLabel q3=new JLabel("How to know the benefits of SBI Home Loans?");
	...
	Help1()
	{
		...
		setVisible(true);
		setSize(900,300);
		click1.addMouseListener(new MouseAdapter()  
{  
