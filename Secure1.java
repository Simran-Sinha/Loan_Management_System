...
import java.sql.*;
public class Secure1 extends JDialog implements ActionListener
{
	Connection con;
	...
	JLabel lb = new JLabel("          Unsecured Personal Loan");
	DefaultMutableTreeNode main=new DefaultMutableTreeNode("SBI Unsecured Personal Loan Details");
	DefaultMutableTreeNode home1=new DefaultMutableTreeNode("Unsecured Personal Loan");
...
tree.addMouseListener(
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		try
		{
		Desktop.getDesktop().open(new java.io.File("img/personal.pdf"));
		}
		catch(Exception e)
		{
		e.printStackTrace();
